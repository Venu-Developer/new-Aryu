  ...
  return (
    <div className=''>
        ...
        <div className='mt-10 md:mt-15'>
            <div className=''><h2 className='text-center text-3xl lg:text-4xl  xl:text-5xl font-bold mt-2 bg-text-heading bg-clip-text text-transparent p-2'>Porfolio</h2></div>
